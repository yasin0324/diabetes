<template>
    <div class="main">
        ...
        <div class="BannerFeed">
            <div class="userNews">
                <h1>
                    我的反馈记录<el-icon><CopyDocument /></el-icon>
                </h1>
        ...
        <el-dialog v-model="dialogonDelFeed">
            ...
            <template #footer>
                <div class="dialog-footer">
                    ...
                    <el-button type="danger" @click="delIN"> 确定 </el-button>
                </div>
            </template>
        </el-dialog>
    </div>
...
watchEffect(() => {
    if (
        feedBackPictures.value.length === selectedFiles.value.length &&
        feedBackPictures.value.length > 0
    ) {
...
const UserFeedrules = ref({
    type: [{ required: true, message: "请输入反馈类型", trigger: "blur" }],
    mobile: [
