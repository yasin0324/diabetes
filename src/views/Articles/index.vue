<template>
    <div class="header">
        <div>
            ...
            >
                <template #append>
                    <el-button plain class="buttonSearch" @click="searchNews">
                        搜索
                    </el-button>
                </template>
            </el-input>
        ...
        <div class="headerSearch">
            <el-row>
                ...
                <el-col :span="6">
                    ...
                    >
                        <ul>
                            <li style="color: #a3c576; font-size: 1.5vw">
                                <el-icon style="padding-right: 10px"
                                    ><Pointer /></el-icon
                                >文章点赞排行
                            </li>
                            <li
                                v-for="(item, index) in frontRight"
                                :key="index"
                                class="frontNews"
                            >
                                <a :href="item.link" target="_blank">
        ...
        getTextNews(data)
            .then((res) => {
                ...
                NewsArticles.value.forEach((article, index) => {
                    fillColor1Array[index] = {
                        color: defaultColor,
                        id: article.id,
                    };
                    fillColor2Array[index] = {
                        color: defaultColor,
                        id: article.id,
                    };
                });
...
function toggleColor1(index, item) {
    ...
    //     }, 500);
    fillColor1.value[index].color =
        fillColor1.value[index].color === "#dbdbdb" ? "#FFA500" : "#dbdbdb";
...
function toggleColor2(index, item) {
    ...
    fillColor2.value[index].color =
        fillColor2.value[index].color === "#dbdbdb" ? "#ff0000" : "#dbdbdb";
    activeIndex.value = index;
